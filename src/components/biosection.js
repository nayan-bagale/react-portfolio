...
export default function biosection() {
  return (
    <section className=" min-h-screen mt-16 flex flex-col items-center md:flex-row-reverse md:mt-0 md:m-4 ">
      <div className="relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-60 h-60 mt-10 overflow-hidden md:w-1/2 md:w-80 md:h-80">
